...
export function parseYAMLFrontMatter(md) {
...
export function parseMarkdown(md) {
  ...
  html = html.replace(
    /^---$/gim,
    '<div style="display:flex;align-items:center;gap:1rem;margin:2rem 0;"><div style="flex:1;height:1px;background:var(--line);"></div><span style="color:var(--muted);">&#10022;</span><div style="flex:1;height:1px;background:var(--line);"></div></div>'
  );
